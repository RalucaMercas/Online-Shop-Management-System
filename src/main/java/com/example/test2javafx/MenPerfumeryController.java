...
public class MenPerfumeryController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (productListView != null) {
            if(currentUser.getRole() == UserRole.CLIENT) {
                productListView.getItems().addAll(DBUtils.getVisibleProductsInStockFromBD(5));
            } else {
                if(currentUser.getRole() == UserRole.ADMIN) {
                    productListView.getItems().addAll(DBUtils.getAllVisibleProductsFromBD(5));
                }
            }
                    ...
                    if (empty || product == null) {
                        ...
                        if (DBUtils.getCurrentUser() != null && DBUtils.getCurrentUser().getRole() == UserRole.ADMIN) {
                            ...
                            editButton.setOnAction(event -> {
                                ...
                                // Callback to handle the updated product when it's available
        ...
        button_remove_product.setOnAction(event -> {
            ...
            if (!selectedProducts.isEmpty()) {
                ...
                if (result.isPresent() && result.get() == ButtonType.OK) {
                    ...
                    updateAdminMenPerfumeryProductListView();
                }
            } else {
    ...
    private void updateAdminMenPerfumeryProductListView() {
        if (productListView != null) {
